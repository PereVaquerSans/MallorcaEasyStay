...
async function initMap() {
  ...
  // 1) Render fallback data IMMEDIATELY — user sees content in <100ms
  allBusinesses = fallbackList;
  applyFilters();

  // 2) Try API in the background with short timeout
  fetchBusinessesInBackground();

  // 3) Init all UI interactions
